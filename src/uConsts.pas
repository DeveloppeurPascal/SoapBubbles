...
const
  ...
  /// </summary>
  CAboutGameURL = 'https://soapbubbles.gamolf.fr';
...
{$ENDIF}
  ...
  /// </summary>
  CGameGUID = '{B1A0D841-0362-4E85-953B-3BC351327EEC}';
